...
public class ForkJoinProcess1Tests {
	...
	public static ProcessDefinition scenario1() {
		return createProcess("FORKJOIN_SCENARIO_1", 0)
				...
				.add(logic("CREATE").application("test")
						...
						.build())
				.add(logic("CONCAT").application("test")
	...
	public static ProcessDefinition scenario2() {
		return createProcess("FORKJOIN_SCENARIO_2", 0)
				...
				.add(group(logic("CREATE").application("test").input("key", "key21").input("value", "v21").input("delayed", 750L).build(),
						   logic("CREATE").application("test").input("key", "key22").input("value", "v22").input("delayed", 750L).build(),
						   logic("CREATE").application("test").input("key", "key23").input("value", "v23").input("delayed", 500L).build())
						.fork("F2")
						.build())
				.add(logic("CREATE").application("test")
