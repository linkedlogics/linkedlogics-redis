...
import io.linkedlogics.redis.process.RedisProcess1Tests.RedisTestContextService;
...
@LinkedLogicsRegister(serviceConfigurerClasses = RedisServiceConfigurer.class, serviceClasses = RedisTestContextService.class)
public class RedisProcess1Tests {
	...
	public void testScenario1() {
		...
		RedisTestContextService.blockUntil();
		long finish = System.currentTimeMillis();

		Context ctx = RedisTestContextService.getCurrentContext();
	...
	public static class RedisTestContextService extends RedisContextService {

		private static Context currentContext;
		private static Object object = new Object();
		
		public RedisTestContextService() {
			resetCurrentContext();
		}
